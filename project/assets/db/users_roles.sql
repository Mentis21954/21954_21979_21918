...
CREATE TABLE IF NOT EXISTS `login_db`.`users_roles` (
  ...
  CONSTRAINT `fk_users_roles_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `login_db`.`user` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
use login_db;
insert into user values ('1','test@gmail.com','$2a$12$jsvf6S4wD3MexUJDdFaaKOJDNtaMn57BICEQ65y7uxX8fBP/gIPe.',1);
insert into user values ('2','student@gmail.com','$2a$12$jsvf6S4wD3MexUJDdFaaKOJDNtaMn57BICEQ65y7uxX8fBP/gIPe.',1);
